...
class _HotelSignUpState extends State<HotelSignUp> {
  ...
  Widget build(BuildContext context) {
    bool isError = false;
    TextEditingController hotelNameTec = new TextEditingController();
    TextEditingController hotelDescTec = new TextEditingController();
    ...
    void updateDetails() async {
      ...
      Map<String, String> userDetails = {
        "hotelName": hotelNameTec.text,
        "hotelDesc": hotelDescTec.text,
      ...
      var response = await dio.post("http://10.0.2.2:9092/signupHotel",
          data: userDetails);
                          ...
                          child: Column(
                            children: [
                              TextFormField(
                                ...
                                controller: hotelNameTec,
                                validator: (val) {
                                  return val.isEmpty || val.length < 4
                                      ? "Hotel Name should be greater than 4"
                                      : null;
                                },
                              ...
                              TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  prefixIcon: Icon(FontAwesomeIcons.ad),
                              ...
                              TextFormField(
                                ...
                                validator: (val) {
                                  return val.isEmpty || val.length < 4
                                      ? "Registration Number should be greater than 4"
                                      : null;
                                },
                                decoration: const InputDecoration(
