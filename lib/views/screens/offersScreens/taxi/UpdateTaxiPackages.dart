...
class UpdateTaxiPackageScreen extends StatefulWidget {
  const UpdateTaxiPackageScreen({Key key, @required this.taxiPackageModel})
      : super(key: key);

  final TaxiPackageModel taxiPackageModel;

  @override
  _UpdateTaxiPackageScreenState createState() =>
      _UpdateTaxiPackageScreenState();
}
                    ...
                    ? Column(
                        ...
                        children: [
                          ...
                          UpdateFormField(
                              ...
                              initialName:
                                  widget.taxiPackageModel.otherFacility == null
                                      ? ""
                                      : widget.taxiPackageModel.otherFacility,
                              maxline: 10,
                              minline: 4),
