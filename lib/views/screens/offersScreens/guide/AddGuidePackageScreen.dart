...
class _AddGuideScreenState extends State<AddGuideScreen> {
  ...
  Future<void> uploadImage() async {
    ...
    if(image != null){
      ...
      var snapshot= await storage.ref()
          .child('offers/guide/'+widget.userId.toString()+'/'+ image.path.split('/').last)
          .putFile(image);
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),
               Title("Places"),
              SizedBox(height: 8,),
              InputFormField(emptyMsg: "Places can not be empty",setValue: setPlaces,maxline: 1,minline: 1 ),
              ...
              Title("Languages"),
              SizedBox(height: 8,),
              InputFormField(emptyMsg: "Languages can not be empty",setValue: setLanguage,maxline: 1,minline: 1 ),
              ...
              Row(
                ...
                children: [
                  Expanded(
                      child: Text("Maximum Group Capacity", style: TextStyle(color: Colors.white),)
                  ),
                  ...
                  Text(_groupCapacity.toString(), style: TextStyle(color: Colors.white)),
  ...
  void createPackage() async{
    ...
    GuidePackageModel package=new GuidePackageModel(_packageName,_description,_places,imageURL,_language,_groupCapacity,_perDay,!_perDay,_price,_negotiable,widget.userId);
